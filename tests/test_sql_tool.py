...
from forge.runtime.integrations.sql_tool import query_database, create_sql_tool
...
class TestSqlToolSanitizer:
    ...
    @pytest.mark.asyncio
    async def test_multi_statement_blocked(self, tmp_db):
    ...
    @pytest.mark.asyncio
    async def test_comment_stripping_block_comment(self, tmp_db):
    ...
    @pytest.mark.asyncio
    async def test_comment_stripping_line_comment(self, tmp_db):
    ...
    @pytest.mark.asyncio
    async def test_tautology_warning_still_executes(self, tmp_db):
    ...
    @pytest.mark.asyncio
    async def test_create_table_allowed(self, tmp_db):
